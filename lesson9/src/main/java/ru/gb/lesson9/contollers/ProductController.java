...
public class ProductController {
    ...
    public ResponseEntity<Product> save(@RequestBody Product product) {
        ...
        //При отсутсвиие аннотации @GeneratedValue вставляет в базу без таблицы сиквиенсов
        // но! у вновь вставленного продукта ID 0...
        //Нужен сиквиенс, при аннотации @GeneratedValue требует сиквиенс, но зато автоматически выдает Id
